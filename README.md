...
> \[!WARNING\] Always preview the whole site with plain `quarto preview`. Never preview a single page (`quarto preview index.qmd`): pages that list other pages come out empty, and the broken output lands in `docs/`.
...
- [ ] Add responsive form for yearly EC updates
- [ ] Package of yearly conference materials for co-chairs
