  ...
  columns = list(
    ...
    time = colDef(
        ...
        cell = merge_column(preconf, 
                            ...
                            merged_size = 16,
                            merged_color = "var(--apls-muted, #5A6268)",
                            merged_position = "below")
        ),
...
tbl <- tbl_wks |> 
  ...
  htmlwidgets::prependContent(
    tagList(
      ...
      tags$h3("Wednesday March 15, 2023", style="font-family:Chivo;margin-bottom:20px;margin-top:0;font-weight:400;color:#5A6268;padding-left:40px;")
  )
  ) |> 
  #footnote and source
