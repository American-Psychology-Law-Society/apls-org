...
![](images/ap-ls-cover-2023){fig-align="center" width="250" fig-alt="2023 AP-LS Conference program cover"}
:::
...
<div class="d-flex flex-wrap justify-content-start align-items-center">
  ...
  [{{< fa file-pdf >}} Program Grid](files/2023_APLS_program_grid_final.pdf){.btn .btn-outline-primary role="button" download="2023_APLS_program_grid_final.pdf"}
</div>
...
grid <- grid |> 
  ...
  mutate(
    img = case_when(
      type == "Networking" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Networking.png",
      type == "Session" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Session.png",
      type == "Poster" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Poster.png",
      type == "Coffee" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Coffee.png",
      type == "Committee" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Committee.png",
      type == "Plenary" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Plenary.png",
      type == "Featured" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Plenary.png",
      type == "Award" ~
        "https://github.com/emmarshall/apls-org/raw/main/images/tbl/Award.png"
    )
  ) 
...
tbl_grid <- reactable(sd, 
              ...
              columns = list(
                ...
                img = colDef(
                  minWidth = 90,
                  name = "",
                  # embed_img() has no alt parameter, so build the tag
                  # directly; the alt names the session type the icon shows.
                  cell = function(value, index) {
                    img(src = value, height = "70px", width = "70px",
                        alt = grid$type[index],
...
tbl <- tbl_grid |> 
  ...
  htmlwidgets::prependContent(
    tagList(
      tags$img(src = "../../../images/logo-blue.png", alt = "AP-LS logo", style = "width:50px;height:50px;display:inline-block;vertical-align:middle;"),
      ...
      tags$h3("Schedule at a glance", style="margin-bottom:20px;margin-top:0;font-weight:400;color:#8C8C8C;opacity:1;padding-left:40px;")
  )
  ) |> 
  #footnote and source
  ...
  tags$a(href = "https://github.com/emmarshall/apls-org/raw/main/conferences/files/2023_APLS_program_grid_final.pdf", download = "2023_APLS_program_grid_final.pdf", class = "btn-action-primary btn-action btn btn-primary", role="button", "Download Schedule")
),
    tags$div(
