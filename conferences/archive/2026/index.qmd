...
::: heading-guard
:::
# 2026 Annual Conference of the American Psychology-Law Society {.h4}

[{{< fa location-dot aria-hidden="true" >}} Reno, Nevada]{.h5}

[{{< fa calendar aria-hidden="true" >}} March 12-14, 2026]{.h5}
...
content <- rowwise_table(
  ...
  "Archives", "journal-text", "../index.qmd"
)
...
::: col
![Map of Hotel layout](images/apls2026hotel_map.png){fig-alt="Map of the 2026 conference hotel layout"}
:::
::::
...
-   **{{< fa file-pdf >}} AP-LS Program Grid** - An abbreviated schedule of conference events that provides a quick overview of sessions, times, and locations.

-   **{{< fa file-pdf >}} AP-LS Conference Program** - A comprehensive program of conference events that incorporates and expands upon the Program Grid with full session details.

-   **{{< fa file-pdf >}} AP-LS Book of Abstracts** - An extensive catalogue of all conference sessions including titles, authors, affiliations, and complete abstracts for every presentation.
...
[Download the app before you arrive]{.h5}
...
::: col
![QR Code to view exordio guide](images/apls2026_exordio.png){fig-alt="QR code to view the Exordio conference guide"}
:::
:::
...
[All conference sessions are located in the [Tuscany Ballroom]{.highlight}.]{.h6}
...
[{{< fa screwdriver-wrench aria-hidden="true" >}} **AV Equipment**]{.h6}
...
[{{< fa gears aria-hidden="true" >}} **Room Setup**]{.h6}
...
[[Conference Contacts]{.highlight}]{.h6}
...
[[{{< fa calendar aria-hidden="true" >}} Wednesday, March 11, 2026]{.highlight}]{.h6}
...
[[{{< fa calendar aria-hidden="true" >}} Thursday, March 12, 2026]{.highlight}]{.h6}
...
[[{{< fa calendar aria-hidden="true" >}} Friday, March 13, 2026]{.highlight}]{.h6}
...
[[{{< fa calendar aria-hidden="true" >}} Saturday, March 14, 2026]{.highlight}]{.h6}
...
[{{< fa id-badge aria-hidden="true" >}} Online registration is open on December 1st!]{.h5}
...
[The 2026 AP-LS Conference will be held at the [Peppermill Resort Spa Casino](https://www.peppermillreno.com/)]{.h6}
...
[{{< fa location-dot aria-hidden="true" >}} Get Directions](https://www.google.com/maps?q=peppermill+reno&fb=1&gl=us&hq=peppermill+reno&cid=0,0,5940142782430245740&t=m&z=16&iwloc=A){.btn .btn-outline-primary role="button"}
:::
...
[Learn More {{< fa arrow-right aria-hidden="true" >}}](../index.qmd){.btn-action .btn .btn-secondary .btn-lg role="button"}
