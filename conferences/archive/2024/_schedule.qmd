...
::: hero-buttons
[Go Back](index.qmd){#btn-guide .btn-action .btn-action .btn .btn-success role="button"} [View Full Program](https://drive.google.com/file/d/1AdoNy8cd22t6B4I5YqhcjaI-ByK8x_eF/view?usp=sharing){.btn-action .btn .btn-secondary role="button"}
:::
:::
:::
:::
                                 ...
                                 title = colDef(
                                   ...
                                   cell = function(value, index) { 
                                     ...
                                     div(
                                       ...
                                       div(style = "font-size: .775rem; color: var(--apls-muted, #5A6268)", subtitle)
                                     )
                                   }
                                 ),
