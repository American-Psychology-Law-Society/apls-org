...
In its history, the Executive Committee has only approved three official Scientific Review Papers of the American Psychology-Law Society. Links to view each paper online and download it as a PDF are included below. 

If you have any questions, contact the [AP-LS Scientific Paper Committee](../about/committees.html). 

::: about-link
[SRP Committee terms of reference & approval process](srp-terms-of-reference.qmd)
:::
...
-   [**Policy and Procedure Recommendations for the Collection and Preservation of Eyewitness Identification Evidence (2020)**]{.smallcaps} [{{< fa arrow-up-right-from-square >}}](https://psycnet.apa.org/fulltext/2020-06220-002.html){aria-label="Policy and Procedure Recommendations for the Collection and Preservation of Eyewitness Identification Evidence on PsycNet"}
...
-   [**Police-induced Confessions: Risk Factors and Recommendations (2010)**]{.smallcaps} [{{< fa arrow-up-right-from-square >}}](https://psycnet.apa.org/record/2010-02823-002){aria-label="Police-induced Confessions: Risk Factors and Recommendations on PsycNet"}
...
-   [**Eyewitness Identification Procedures: Recommendations for Lineups and Photospreads (1998)**]{.smallcaps} [{{< fa arrow-up-right-from-square >}}](https://psycnet.apa.org/fulltext/1998-03228-001.html){aria-label="Eyewitness Identification Procedures: Recommendations for Lineups and Photospreads on PsycNet"}
