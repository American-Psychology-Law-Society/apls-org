...
[Learn More {{< fa arrow-right >}}](https://drive.google.com/file/d/12-EMOWANyIhRnrAsGaPMx-LSKcP4gYDy/view?usp=sharing){.btn-action-primary .btn-action .btn .btn-primary .btn-lg role="button"}
:::
...
Two awards (one clinical one experimental) are conferred annually at the AP-LS Annual Conference. Each recipient receives a plaque and \$1,000. The recipients also delivers the annual Saleem Shah Address at the AP-LS conference.
...
# Data: awards/data/saleem-shah.csv (refresh via awards/_update-awards.R)
