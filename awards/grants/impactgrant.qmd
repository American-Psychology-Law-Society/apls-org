...
::: callout-tip
Funding should primarily support research activities and data collection efforts. Support for research assistants and necessary travel may be requested, but should not constitute the majority of the requested funds. Applicants may request up to 100% of funds to cover faculty FTE in the form of a stipend. This means that salary support and fringe can be covered.
...
Based on review of the pre-proposals, investigators will be notified by November 15 about whether they are invited to submit a full proposal application. Full proposal applications will be due by December 16, `r format(Sys.Date(), '%Y')` at 11:59 p.m. PST.
...
For investigators invited to submit full proposal applications, full proposal applications are due by December 16, `r format(Sys.Date(), '%Y')` at 11:59pm PST.
