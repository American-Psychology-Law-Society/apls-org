...
submission-info:
  ...
  deadline: 
  - "January 15, `r if (Sys.Date() > lubridate::mdy(paste('January 15', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())`" 
  - "September 15, `r if (Sys.Date() > lubridate::mdy(paste('September 15', lubridate::year(Sys.Date())))) lubridate::year(Sys.Date()) + 1 else lubridate::year(Sys.Date())`"
links:
- icon: envelope-at
  name: Apply here
  url: "mailto:undergrad_grants@ap-ls.org"
---
