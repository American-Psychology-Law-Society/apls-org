...
- icon: envelope-at
  name: Contact
  url: "mailto:cwillis-esqueda1@unl.edu"
- icon: send
  name: Apply here
...
The AP program will award up to `$4,000` per student, depending on the length of the research experience. Recipients will be given a stipend of `$1,500` per semester.

In addition, they will receive $1000 to attend the AP-LS conference (physically provided upon attendance at the conference).

Four awards of `$4,000` (i.e., for year-long experiences) or a larger number of smaller awards (i.e., for part-year experiences) will be given.
...
For more information about the AP Program, please contact the program chair, [Cynthia Willis-Esqueda](mailto:cwillis-esqueda1@unl.edu).
