...
<p class="display-2"><span class="currency">$</span>100<span class="period">/yr</span></p>
</div>
<div class="price-card-block">
<h3 class="price-card-title">
        Full or Associate
      </h3>
<h4 class="price-card-subtitle">
  Individuals with psych or related degrees: </h4>
<ul class="list-group">
  <li class="list-group-item">Doctoral Degree</li>
  <li class="list-group-item">Juris Doctorate</li>
  <li class="list-group-item">Master's Degree</li>
  <li class="list-group-item">Terminal Bachelor's Degree</li>
</ul>
<center><a href="https://apls.memberclicks.net/membership-form#!/" class="price-btn price-btn-gradient mt-2">Join now</a></center>
</div>
</div>
</div>
:::
...
<div class="card-body d-flex flex-column">
<div class="price-card-header">
<p class="display-2"><span class="currency">$</span>50<span class="period">/yr</span></p>
</div>
<div class="price-card-block">
<h3 class="price-card-title"> Early Career </h3>
<h4 class="price-card-subtitle">
  Individuals within first 3 years post terminal degree: </h4>
<ul class="list-group">
  <li class="list-group-item">Doctoral Degree</li>
  <li class="list-group-item">Juris Doctorate</li>
  <li class="list-group-item">Master's Degree</li>
...
<div class="card-body d-flex flex-column">
<div class="price-card-header">
<p class="display-2"><span class="currency">$</span>30<span class="period">/yr</span></p>
</div>
<div class="price-card-block">
<h3 class="price-card-title"> Student </h3>
<h4 class="price-card-subtitle">
  Individuals currently enrolled as either: </h4>
...
::: content-block-blue
[Did you receive a renewal notice from the AP-LS Office?]{.h6} 

Please complete this renewal form and continue receiving member benefits with AP-LS.

[Renew Here! {{< fa arrow-right >}}](https://apls.memberclicks.net/membership-renewal-form#!/){.btn-action .btn .btn-secondary .btn-lg role="button"}
:::
:::
...
[Members of AP-LS enjoy a variety of benefits including:]{.h6}
...
[There are ***six*** categories of membership in AP-LS including:]{.h6}
...
content = rowwise_table(~name, ~icon, ~url, ~text,
  "Full", "person-fill",      "",                                   "Individuals with a doctoral degree (Ph.D., Psy.D., M.D., or Ed.D.) in psych or related field or a Juris Doctorate.",
    "Associate", "person-fill",      "",                                   "Individuals with a master's degree in psych or related field or a terminal bachelor's degree.",
    "Early Career", "person-fill",      "",                                   "Individuals within the first 3 years post terminal degree.",
    "Fellows", "award",      "",                                   "Individuals granted Fellow Status (Full Members) or Distinguished Member status (Full Affiliates) by the society.",
...
div(class = "grid grid-three",
  pmap(content, function(name, icon, url, text, objective) {
      div(class = "grid__item",
        ...
        if (url == "") NULL else a(href = url, `aria-label` = name, span(class = "grid__link-box"))
      )
  })
)
```
